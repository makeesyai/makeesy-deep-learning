...
class TransformerEncoderDecoder(nn.Module):
    def __init__(self, src_vocab, trg_vocab, d_model, num_enc_layers, num_dec_layers, num_heads, ff_size, dropout):
...
if __name__ == '__main__':
    ...
    model = TransformerEncoderDecoder(src_vocab, trg_vocab, d_model, num_enc_layers=2,
                                      num_dec_layers=2, num_heads=4, ff_size=512, dropout=0.1)
